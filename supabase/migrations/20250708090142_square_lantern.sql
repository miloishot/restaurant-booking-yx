/*
  # Create comprehensive sample booking data for trend analytics

  1. Sample Data Creation
    - 30 days of realistic booking history
    - Weekend vs weekday patterns
    - Peak hour distributions (lunch & dinner rush)
    - Menu categories and items with pricing
    - Order data with revenue tracking
    - Loyalty program integration
    - Waitlist entries for high-demand periods

  2. Analytics Features
    - Time slot analytics (15-minute intervals)
  ...
  3. Realistic Patterns
    - Higher volumes on weekends
    - Lunch rush (12-2 PM) and dinner rush (6-8 PM)
    - Natural booking variations
    - Lead time distributions
    - Order combinations and pricing
*/
        ...
        FOR i IN 1..booking_count LOOP
          ...
          IF should_create_order THEN
            ...
            INSERT INTO order_sessions (
              ...
              'session_' || gen_random_uuid()::TEXT, false,
            ...
            INSERT INTO orders (
              ...
              CASE WHEN loyalty_applied THEN 'user_' || gen_random_uuid()::TEXT ELSE NULL END,
              'paid',
              booking_created_at + INTERVAL '2 hours',
