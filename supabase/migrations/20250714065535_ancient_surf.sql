/*
  ...
  1. Changes
    - Drop all existing RLS policies on employees table
    - Create new policies using auth.uid() instead of uid()
    - Fix infinite recursion issues in policies
    - Ensure proper restaurant-employee binding
*/
...
-- Create a policy for restaurant owners to manage employees
-- This avoids the recursion by directly checking the restaurants table
