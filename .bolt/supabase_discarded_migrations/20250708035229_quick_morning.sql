/*
  # Create Test Restaurant and Fix Authentication Issues

  This migration creates a test restaurant with sample data and fixes RLS policies
  to allow public access to booking pages. The test user will need to be created
  through the Supabase Auth UI or signup process.

  ## Changes Made
  1. Create test restaurant with slug 'test-restaurant'
  2. Add comprehensive test data (tables, hours, customers, bookings)
  3. Fix RLS policies for public booking access
  4. Update functions to work without authentication
  5. Create helper functions for development

  ## Test Access
  - Restaurant URL: /test-restaurant (public access)
  - Admin access: Sign up with any email and it will be linked to test restaurant
*/
...
(
  '11111111-1111-1111-1111-111111111111',
  (SELECT id FROM restaurant_tables WHERE restaurant_id = '11111111-1111-1111-1111-111111111111' AND table_number = '1' LIMIT 1),
...
(
  '11111111-1111-1111-1111-111111111111',
  (SELECT id FROM restaurant_tables WHERE restaurant_id = '11111111-1111-1111-1111-111111111111' AND table_number = '3' LIMIT 1),
...
(
  '11111111-1111-1111-1111-111111111111',
  (SELECT id FROM restaurant_tables WHERE restaurant_id = '11111111-1111-1111-1111-111111111111' AND table_number = '5' LIMIT 1),
